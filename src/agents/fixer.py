...
def fix_code(
    ...
    input_prompt += "Return ONLY the corrected Python code, no markdown, no backticks, nothing else.\n\n" f"{code}"
    ...
    log_experiment(
        ...
        model_used="gemini-1.5-flash",
        action=ActionType.FIX,
        details={"input_prompt": input_prompt, "output_response": fixed_code},  # ✅ log clean code
        status="SUCCESS",
    )
